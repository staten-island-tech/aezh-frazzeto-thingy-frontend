  ...
  <catalog-cat-header > </catalog-cat-header>
    <div class="flex gap-4 items-start p-[1%] forum text-black font-bold rounded-2xl shadow-lg text-lg bg-slate-200 w-full h-[70vh]! mt-[3vh] overflow-y-scroll flex-wrap relative">
      ...
      <pagination class="bg-white absolute lg:w-[40%] w-[60%] h-[10%] lg:left-[30%] left-[20%] rounded-2xl bottom-2 shadow-md flex justify-between items-center px-2">
        <button class="bg-slate-200 aspect-square h-[80%] rounded-2xl flex items-center justify-center shadow-sm hover:shadow-md hover:bg-slate-300 active:shadow-none active:bg-sky-400/60 transition-all duration-300 ease-in-out"> <ArrowLeft :size="24" /> </button>
        <p class="text-2xl forum"> Pg. 300 </p>
        <button class="bg-slate-200 aspect-square h-[80%] rounded-2xl flex items-center justify-center shadow-sm hover:shadow-md hover:bg-slate-300 active:shadow-none active:bg-sky-400/40 transition-all duration-300 ease-in-out"> <ArrowRight :size="24" /> </button>
      </pagination>
    </div>
  </div>
</template>
