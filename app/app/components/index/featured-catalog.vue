<template>
    <div class="w-[45%] rounded-2xl flex flex-col bg-[#FFE9CC] h-full border-2 border-[#ffcbab] p-[1%]">
        <div class="flex flex-row h-[20%] items-center justify-between">
            <h2 class="forum text-2xl text-black"> Interested in these?</h2>
            <button @click="async () => {await navigateTo('/catalog')}"
            class="forum text-2xl bg-[#FAE6DA] border-[#ffcbab] border-2  px-[5%] text-black
