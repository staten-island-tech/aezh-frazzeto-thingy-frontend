<template>
  <div
    class="w-full rounded-2xl flex flex-col bg-slate-200 min-h-[55vh] lg:h-full p-[1%] shadow-lg"
  >
    <div class="flex flex-row h-[20%] items-center justify-between px-[1%]">
      <h2 class="forum text-[1.8rem] text-black font-bold">
        Interested in these?
      </h2>
      <button
        @click="
        ...
        <div class="flex flex-col min-w-[50%] w-full over">
          ...
          >
            ...
            <NuxtLink
              ...
              class="bg-slate-100 shadow-md hover:shadow-lg active:shadow-none w-[55%] py-2 rounded-lg hover:bg-sky-400/20 active:bg-sky-400/60 transition-all duration-300 ease-in-out hover:-translate-y-0.5 active:translate-y-px flex items-center justify-center forum font-bold absolute bottom-2"
              >See More</NuxtLink
            >
          </div>
        </div>
