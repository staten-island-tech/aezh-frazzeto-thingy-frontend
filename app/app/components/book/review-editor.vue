<template>
    <div class="flex flex-col gap-2 min-w-full min-h-[60%] bg-slate-200 rounded-2xl shadow-md p-2">
        <div class='flex flex-row justify-between items-center px-2 gap-2'>
            ...
            <p class="text-xs lg:text-md forum italic"
        ...
        <div class="rating rating-lg items-center justify-between px-2">
            ...
            <input @click="starRating = 0; reviewed = true" type="radio" name="rating-10"
                class="rating-hidden bg-yellow-500" aria-label="clear" />
            <input @click="starRating = 1; reviewed = true" type="radio" name="rating-10"
                class="mask mask-star-2 bg-yellow-500" aria-label="1 star" />
            <input @click="starRating = 2; reviewed = true" type="radio" name="rating-10"
                class="mask mask-star-2 bg-yellow-500" aria-label="2 star" />
            <input @click="starRating = 3; reviewed = true" type="radio" name="rating-10"
                class="mask mask-star-2 bg-yellow-500" aria-label="3 star" />
            <input @click="starRating = 4; reviewed = true" type="radio" name="rating-10"
                class="mask mask-star-2 bg-yellow-500" aria-label="4 star" />
            <input @click="starRating = 5; reviewed = true" type="radio" name="rating-10"
                class="mask mask-star-2 bg-yellow-500" aria-label="5 star" />
        </div>
